...
class BotController:
    ...
    def start(self):
        ...
        try:
            ...
            card_transfer_flag = database.get_setting("card_transfer_enabled")
            card_number = database.get_setting("card_number")
            card_transfer_enabled = (
                str(card_transfer_flag).lower() in ("true", "1", "yes", "on")
                and bool(card_number)
            )
            ...
            handlers.PAYMENT_METHODS = {
                ...
                "card_transfer": card_transfer_enabled,
